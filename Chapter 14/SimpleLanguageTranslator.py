...
def speech_to_text(file_name, model_id):
    ...
    stt = SpeechToTextV1(iam_apikey=keys.speech_to_text_key, url='https://api.eu-gb.speech-to-text.watson.cloud.ibm.com/instances/01ca94f4-4c7f-40f5-8300-c7de3753b88f')
...
def translate(text_to_translate, model):
    ...
    language_translator = LanguageTranslatorV3(version='2018-05-31',
        iam_apikey=keys.translate_key, url='https://api.eu-gb.language-translator.watson.cloud.ibm.com/instances/b97e8f27-4bd5-4003-9f25-68bc281ded6e')
...
def text_to_speech(text_to_speak, voice_to_use, file_name):
    ...
    tts = TextToSpeechV1(iam_apikey=keys.text_to_speech_key, url='https://api.eu-gb.text-to-speech.watson.cloud.ibm.com/instances/000593f3-0574-41fb-a2fa-1587131a51ae')
